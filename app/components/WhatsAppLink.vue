...
const message = '¡Hola! Quiero contactar contigo para proponerte esta idea:\n';
const url = `https://wa.me/34665466974?text=${encodeURIComponent(message)}`;
</script>
